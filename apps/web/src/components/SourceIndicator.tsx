...
function getIconLabel(sourceType: SourceType | "generic"): string {
  switch (sourceType) {
    case "generic":
      return "View sources";
    case "article":
      return "View article sources";
    case "book":
      return "View book sources";
    case "podcast":
      return "View podcast sources";
    case "post":
      return "View post sources";
    case "video":
...
export function SourceIndicator({ chunkIds }: SourceIndicatorProps) {
  ...
  return (
    <div className="source-indicator" ref={rootRef}>
      <div className="source-indicator__buttons">
        {sourceTypes.map((sourceType) => (
          <button
            aria-label={getIconLabel(sourceType)}
            className="source-indicator__button"
            key={sourceType}
            onClick={handleOpen}
            type="button"
          >
